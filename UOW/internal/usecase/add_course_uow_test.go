...
import (
	...
	"github.com/JacksomGuilherme/GoExpert/UOW/internal/db"
	"github.com/JacksomGuilherme/GoExpert/UOW/internal/repository"
	"github.com/JacksomGuilherme/GoExpert/UOW/pkg/uow"
...
func TestAddCourseUow(t *testing.T) {
	dbt, err := sql.Open("mysql", "golang:golang@tcp(localhost:3306)/goexpert")
